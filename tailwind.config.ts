  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        pyramid: {
          DEFAULT: "hsl(var(--pyramid))",
          foreground: "hsl(var(--pyramid-foreground))",
        },
        randomized: {
          DEFAULT: "hsl(var(--randomized))",
          foreground: "hsl(var(--randomized-foreground))",
        },
        ladder: {
          DEFAULT: "hsl(var(--ladder))",
          foreground: "hsl(var(--ladder-foreground))",
        },
        cooldown: {
          DEFAULT: "hsl(var(--cooldown))",
          foreground: "hsl(var(--cooldown-foreground))",
        },
        rest: {
